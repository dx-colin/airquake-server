...
void PF_bprint (void)
{
	...
	s = PF_VarString(0);
	// AirQuake's compiled progs.dat announces kills/deaths through this
	// builtin -- it's the only engine-visible hook into that text, since
	// no QuakeC source exists for this mod to instrument directly.
	SV_Accounts_ObserveBroadcast (s);
