...
// accounts / voting -- see sv_accounts.c. account_name is sized 32 to match
// SV_ACCOUNT_NAME_LEN in sv_accounts.h (kept as a literal here to avoid
// pulling that header into this very-widely-included one).
	...
	double			session_start;		// Sys_DoubleTime() at login, for playtime accrual
