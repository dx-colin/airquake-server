...
Added on top of stock QuakeSpasm. See sv_accounts.c for the design notes.
*/
...
// Host_Init()) to take effect -- see main_sdl.c's -accountsdir handling.
...
// One-shot admin bootstrap/reset, driven by `quakespasm -createadmin <user> <pass>`.
